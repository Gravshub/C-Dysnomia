...
async def get_overview():
    ...
    Makes ~4 RPC round-trips total:
    1. eth_blockNumber
    2. eth_gasPrice
    3. eth_getBalance (Joey wallet + TGSv8)
    4. Multicall3 batch (all token balances)
    
    Plus local file reads for bot state and TX log.
    """
    reader = get_reader()
